...
const SSL_KEY_PATH = process.env.SSL_PRIV_KEY
const SSL_CERT_PATH = process.env.SSL_CERT_KEY
...
httpServer.listen(port_http, () => {
    console.log('WebApp with HTTP runing in PORT ' + port_http)
})

httpsServer.listen(port_https, () => {
    console.log('WebApp with HTTPS runing in PORT ' + port_https)
})
