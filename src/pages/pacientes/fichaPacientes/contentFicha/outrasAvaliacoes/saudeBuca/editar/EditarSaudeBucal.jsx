...
function EditarSaudeBucal() {
    ...
    return (
        <div className="EditarSaudeBucal">
            <div className="LabelInput">
                <label><strong>Ano: </strong></label>
                <input defaultValue={saudeBucal ? saudeBucal.ano: ""} onChange={(e) => setAno(parseInt(e.target.value))} type="number"/>
            </div>
            ...
            <div className="LabelInput">
                ...
                <input defaultValue={saudeBucal ? saudeBucal.p32: ""} onChange={(e) => setP32(e.target.value)} type="text"/>
            </div>
...
export default EditarSaudeBucal;
