        ...
        <div className="AdicionarIvcf" style={{
            ...
            <div className="LabelForm" style={{borderBottom: '1px solid gray', marginBottom: '0.2vh'}}>
                ...
                <div className="LabelInput">
                    ...
                    <input defaultValue={psqi.p1} onChange={(e) => setPsqi({
                        ...psqi,
            ...
            <div className="LabelForm" style={{borderBottom: '1px solid gray', marginBottom: '0.2vh'}}>
                ...
                <div className="LabelInput">
                    ...
                    <input defaultValue={psqi.p2} onChange={(e) => setPsqi({
                        ...psqi,
            ...
            <div className="LabelForm" style={{borderBottom: '1px solid gray', marginBottom: '0.2vh'}}>
                ...
                <div className="LabelInput">
                    ...
                    <input defaultValue={psqi.p3} onChange={(e) => setPsqi({
                        ...psqi,
            ...
            <div className="LabelForm" style={{borderBottom: '1px solid gray', marginBottom: '0.2vh'}}>
                ...
                <div className="LabelInput">
                    ...
                    <input defaultValue={psqi.p4} onChange={(e) => setPsqi({
                        ...psqi,
            ...
            <div className="LabelInput">
                ...
                <input defaultValue={psqi.p5_i} onChange={(e) => setPsqi({
                    ...psqi,
            ...
            <div className="LabelForm" style={{borderBottom: '1px solid gray'}}>
                <div className="LabelInput">
                    ...
                    <input defaultValue={psqi.p10_e_1} onChange={(e) => setPsqi({
                        ...psqi,
