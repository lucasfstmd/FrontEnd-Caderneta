...
import "./AdicionarIntensidades.css"
...
function AdicionarIntensidades(props) {
    ...
    async function handleSalvarApi() {
        try {
            await api.post("v1/intensidades", Intensidade);
            setOpen(true);
        } catch (error) {
    ...
    return (
        <div className="AdicionarIntensidades">
            ...
            <div className="LabelInput">
                ...
                <input value={local_dor} onChange={(e) => setLocalDor(e.target.value)} type="text"/>
            </div>
            <div className="LabelInput">
                <label><strong>Intensidade: </strong></label>
                <input value={intensidade} onChange={(e) => setIntensidade(parseInt(e.target.value))} type="number"/>
            </div>
...
export default AdicionarIntensidades;