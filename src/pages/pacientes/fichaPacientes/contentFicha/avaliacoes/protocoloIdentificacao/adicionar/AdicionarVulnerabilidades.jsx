...
import "./AdicionarVulnerabilidades.css"
...
function AdicionarVulnerabilidades(props) {
    ...
    async function handleSalvarApi() {
        try {
            await api.post("v1/vulnerabilidades", Vulnerabilidade);
            setOpen(true);
        } catch (error) {
    ...
    return (
        <div className="AdicionarVulnerabilidades">
            <div className="LabelInput">
                <label><strong>Ano: </strong></label>
                <input value={ano} onChange={(e) => setAno(parseInt(e.target.value))} type="number"/>
            </div>
            <div className="LabelInput">
                <label id="Titulo"><strong>1. Idade: </strong></label>
            ...
            <div className="LabelInput">
                <label id="Titulo"><strong>2. Autopercepção da Saúde: </strong></label>
            ...
            <label id="Titulo"><strong>3. Limitações Físicas</strong></label>
            <div className="LabelInput">
            ...
            <label id="Titulo"><strong>4. Incapacidades</strong></label>
            <div className="LabelInput">
...
export default AdicionarVulnerabilidades;