...
function AdicionarFragilidades() {
    ...
    const [baixo_nivel_atividade_fisica, setBaixo_nivel_atividade_fisica] = useState();
    ...
    async function handleSalvarApi() {
        try {
            await api.post("v1/fragilidades", Fragilidade);
            setOpen(true);
        } catch (error) {
    ...
    return (
        <div className="AdicionarFragilidades">
            ...
            <div className="LabelInput">
                ...
                <div className="LabelInput">
                    Dias
                    <input value={p5_1a_1} onChange={(e) => setP5_1a_1(e.target.value)} type="text"/>
                    por Semana.
                    <div className="LabelInput">
                        <input value={p5_1a_2} onChange={() => setP5_1a_2(1)} type="checkbox"/>
                        Nenhum
                    </div>
                </div>
            </div>
            <div className="LabelInput">
                ...
                <div className="LabelInput">
                    Horas:
                    <input value={p5_1b_1} onChange={(e) => setP5_1b_1(e.target.value)} type="text"/>
                </div>
                <div className="LabelInput">
                    Minutos:
                    <input value={p5_1b_2} onChange={(e) => setP5_1b_2(e.target.value)} type="text"/>
                </div>
            </div>
            <div className="LabelInput">
                ...
                <div className="LabelInput">
                    Dias
                    <input value={p5_2a_1} onChange={(e) => setP5_2a_1(e.target.value)} type="text"/>
                    por Semana.
                    <div className="LabelInput">
                        <input value={p5_2a_2} onChange={() => setP5_2a_2(1)} type="checkbox"/>
                        Nenhum
                    </div>
                </div>
            </div>
            <div className="LabelInput">
                ...
                <div className="LabelInput">
                    Horas:
                    <input value={p5_2b_1} onChange={(e) => setP5_2b_1(e.target.value)} type="text"/>
                </div>
                <div className="LabelInput">
                    Minutos:
                    <input value={p5_2b_2} onChange={(e) => setP5_2b_2(e.target.value)} type="text"/>
                </div>
            </div>
            <div className="LabelInput">
                ...
                <div className="LabelInput">
                    Dias
                    <input value={p5_3a_1} onChange={(e) => setP5_3a_1(e.target.value)} type="text"/>
                    por Semana.
                    <div className="LabelInput">
                        <input value={p5_3a_2} onChange={() => setP5_3a_2(1)} type="checkbox"/>
                        Nenhum
                    </div>
                </div>
            </div>
            <div className="LabelInput">
                ...
                <div className="LabelInput">
                    Horas:
                    <input value={p5_3b_1} onChange={(e) => setP5_3b_1(e.target.value)} type="text"/>
                </div>
                <div className="LabelInput">
                    Minutos:
                    <input value={p5_3b_2} onChange={(e) => setP5_3b_2(e.target.value)} type="text"/>
                </div>
            </div>
            <div className="LabelInput">
                ...
                <div className="LabelInput">
                    Horas:
                    <input value={p5_4a_1} onChange={(e) => setP5_4a_1(e.target.value)} type="text"/>
                </div>
                <div className="LabelInput">
                    Minutos:
                    <input value={p5_4a_2} onChange={(e) => setP5_4a_2(e.target.value)} type="text"/>
                </div>
            </div>
            <div className="LabelInput">
                ...
                <div className="LabelInput">
                    Horas:
                    <input value={p5_4b_1} onChange={(e) => setP5_4b_1(e.target.value)} type="text"/>
                </div>
                <div className="LabelInput">
                    Minutos:
                    <input value={p5_4b_2} onChange={(e) => setP5_4b_2(e.target.value)} type="text"/>
                </div>
            </div>
            <div className="LabelInput">
