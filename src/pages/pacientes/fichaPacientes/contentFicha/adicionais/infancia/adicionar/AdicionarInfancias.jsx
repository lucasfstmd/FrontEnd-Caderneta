...
function AdicionarInfancias(props) {
    ...
    async function handleSalvarApi() {
        try {
            await api.post("v1/infancias", Infancia);
            setOpen(true);
        } catch (error) {
    ...
    return (
        <div className="AdicionarInfancias">
            ...
            <div className="LabelInput">
                ...
                <input value={a2_a} onChange={(e) => setA2_a(e.target.value)} type="text"/>
                <br/>
            ...
            <div className="LabelInput">
                ...
                <input value={a3_a} onChange={(e) => setA3_a(e.target.value)} type="text"/>
                <br/>
            ...
            <div className="LabelInput">
                ...
                <input value={a5_h} onChange={(e) => setA5_h(e.target.value)} type="text"/>
            </div>
            <div className="LabelInput">
...
export default AdicionarInfancias;